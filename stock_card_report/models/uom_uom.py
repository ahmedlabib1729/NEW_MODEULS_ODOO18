...
class Uom(models.Model):
    ...
    def sh_compute_quantity(self, qty, to_unit, round=True, rounding_method='HALF-UP', raise_if_failure=True):
        ...
        amount = tools.float_round(amount,2,rounding_method=rounding_method)
        return amount
